...
namespace Upcloud.Api
{
    ...
    public partial class IPAddressApi : IIPAddressApi
    {
        ...
        /// <returns></returns>
        public IPAddressApi(Upcloud.Client.Configuration configuration = null)
        {
        ...
        public ApiResponse< AssignIpResponse > AddIpWithHttpInfo (AddIpRequest ipAddress = null)
        {
            ...
            {
                localVarPostBody = this.Configuration.ApiClient.Serialize(ipAddress); // http body (model) parameter
            }
            else
            {
            ...
            return new ApiResponse<AssignIpResponse>(localVarStatusCode,
                ...
                (AssignIpResponse) this.Configuration.ApiClient.Deserialize(localVarResponse, typeof(AssignIpResponse)));
        }
        ...
        public ApiResponse< IpAddressListResponse > ListIpsWithHttpInfo ()
        {
            ...
            return new ApiResponse<IpAddressListResponse>(localVarStatusCode,
                localVarResponse.Headers.ToDictionary(x => x.Key, x => x.Value.ToString()),
                (IpAddressListResponse) this.Configuration.ApiClient.Deserialize(localVarResponse, typeof(IpAddressListResponse)));
        }
