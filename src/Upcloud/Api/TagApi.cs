...
namespace Upcloud.Api
{
    ...
    public partial class TagApi : ITagApi
    {
        ...
        /// <returns></returns>
        public TagApi(Upcloud.Client.Configuration configuration = null)
        {
        ...
        public ApiResponse< CreateNewTagResponse > CreateTagWithHttpInfo (TagCreateRequest tag)
        {
            ...
            {
                localVarPostBody = this.Configuration.ApiClient.Serialize(tag); // http body (model) parameter
            }
            else
            {
            ...
            return new ApiResponse<CreateNewTagResponse>(localVarStatusCode,
                localVarResponse.Headers.ToDictionary(x => x.Key, x => x.Value.ToString()),
                (CreateNewTagResponse) this.Configuration.ApiClient.Deserialize(localVarResponse, typeof(CreateNewTagResponse)));
        }
        ...
        public ApiResponse< TagListResponse > ListTagsWithHttpInfo ()
        {
            ...
            return new ApiResponse<TagListResponse>(localVarStatusCode,
                localVarResponse.Headers.ToDictionary(x => x.Key, x => x.Value.ToString()),
                (TagListResponse) this.Configuration.ApiClient.Deserialize(localVarResponse, typeof(TagListResponse)));
        }
