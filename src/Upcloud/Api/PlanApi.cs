...
namespace Upcloud.Api
{
    ...
    public partial class PlanApi : IPlanApi
    {
        ...
        /// <returns></returns>
        public PlanApi(Upcloud.Client.Configuration configuration = null)
        {
        ...
        public ApiResponse< AvailablePlanListResponse > ListPlansWithHttpInfo ()
        {
            ...
            return new ApiResponse<AvailablePlanListResponse>(localVarStatusCode,
                ...
                (AvailablePlanListResponse) this.Configuration.ApiClient.Deserialize(localVarResponse, typeof(AvailablePlanListResponse)));
        }
