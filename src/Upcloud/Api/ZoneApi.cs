...
namespace Upcloud.Api
{
    ...
    public partial class ZoneApi : IZoneApi
    {
        ...
        /// <returns></returns>
        public ZoneApi(Upcloud.Client.Configuration configuration = null)
        {
        ...
        public ApiResponse< ZoneListResponse > ListZonesWithHttpInfo ()
        {
            ...
            return new ApiResponse<ZoneListResponse>(localVarStatusCode,
                ...
                (ZoneListResponse) this.Configuration.ApiClient.Deserialize(localVarResponse, typeof(ZoneListResponse)));
        }
