...
namespace Upcloud.Api
{
    ...
    public partial class TimezoneApi : ITimezoneApi
    {
        ...
        /// <returns></returns>
        public TimezoneApi(Upcloud.Client.Configuration configuration = null)
        {
        ...
        public ApiResponse< TimezoneListResponse > ListTimezonesWithHttpInfo ()
        {
            ...
            return new ApiResponse<TimezoneListResponse>(localVarStatusCode,
                ...
                (TimezoneListResponse) this.Configuration.ApiClient.Deserialize(localVarResponse, typeof(TimezoneListResponse)));
        }
