...
namespace Upcloud.Api
{
    ...
    public partial class StorageApi : IStorageApi
    {
        ...
        /// <returns></returns>
        public StorageApi(Upcloud.Client.Configuration configuration = null)
        {
        ...
        public ApiResponse< CreateStorageResponse > BackupStorageWithHttpInfo (Guid? storageId, CreateBackupStorageRequest storage)
        {
            ...
            if (storageId != null) localVarPathParams.Add("storageId", this.Configuration.ApiClient.ParameterToString(storageId)); // path parameter
            if (storage != null && storage.GetType() != typeof(byte[]))
            {
                localVarPostBody = this.Configuration.ApiClient.Serialize(storage); // http body (model) parameter
            }
            else
            {
            ...
            return new ApiResponse<CreateStorageResponse>(localVarStatusCode,
                localVarResponse.Headers.ToDictionary(x => x.Key, x => x.Value.ToString()),
                (CreateStorageResponse) this.Configuration.ApiClient.Deserialize(localVarResponse, typeof(CreateStorageResponse)));
        }
        ...
        public ApiResponse< SuccessStoragesResponse > ListStorageTypesWithHttpInfo (string type)
        {
            ...
            return new ApiResponse<SuccessStoragesResponse>(localVarStatusCode,
                localVarResponse.Headers.ToDictionary(x => x.Key, x => x.Value.ToString()),
                (SuccessStoragesResponse) this.Configuration.ApiClient.Deserialize(localVarResponse, typeof(SuccessStoragesResponse)));
        }
