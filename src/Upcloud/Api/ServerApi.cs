...
namespace Upcloud.Api
{
    ...
    public interface IServerApi : IApiAccessor
    {
        ...
        /// </remarks>
        /// <exception cref="Upcloud.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="serverId">Id of server on which to cancel the current operation.</param>
        /// <returns></returns>
        void CancelServer (Guid? serverId);
        ...
        ApiResponse<Object> CancelServerWithHttpInfo (Guid? serverId);
        /// <summary>
        ...
        /// <param name="storages">Detaches and deletes storages on the server. (optional)</param>
        /// <returns></returns>
        void DeleteServer (Guid? serverId, decimal? storages = null);
        ...
        /// <param name="storages">Detaches and deletes storages on the server. (optional)</param>
        /// <returns>ApiResponse of Object(void)</returns>
        ApiResponse<Object> DeleteServerWithHttpInfo (Guid? serverId, decimal? storages = null);
        /// <summary>
        /// Detach storage
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task CancelServerAsync (Guid? serverId);
        ...
        System.Threading.Tasks.Task<ApiResponse<Object>> CancelServerAsyncWithHttpInfo (Guid? serverId);
        /// <summary>
        /// Create firewall rule
        /// </summary>
        /// <remarks>
        ...
        /// <param name="storages">Detaches and deletes storages on the server. (optional)</param>
        /// <returns>Task of void</returns>
        System.Threading.Tasks.Task DeleteServerAsync (Guid? serverId, decimal? storages = null);
        ...
        /// <param name="storages">Detaches and deletes storages on the server. (optional)</param>
        /// <returns>Task of ApiResponse</returns>
        System.Threading.Tasks.Task<ApiResponse<Object>> DeleteServerAsyncWithHttpInfo (Guid? serverId, decimal? storages = null);
        /// <summary>
        /// Detach storage
        /// </summary>
        /// <remarks>
    ...
    public partial class ServerApi : IServerApi
    {
        ...
        {
            this.Configuration = new Upcloud.Client.Configuration { BasePath = basePath };
        ...
        /// <returns></returns>
        public ServerApi(Upcloud.Client.Configuration configuration = null)
        {
            if (configuration == null) // use the default one in Configuration
                this.Configuration = Upcloud.Client.Configuration.Default;
            else
        ...
        public Upcloud.Client.Configuration Configuration {get; set;}
        ...
        public ApiResponse< CreateServerResponse > AssignTagWithHttpInfo (Guid? serverId, string tagList)
        {
            ...
            if (tagList != null) localVarPathParams.Add("tagList", this.Configuration.ApiClient.ParameterToString(tagList)); // path parameter
            ...
            return new ApiResponse<CreateServerResponse>(localVarStatusCode,
                ...
                (CreateServerResponse) this.Configuration.ApiClient.Deserialize(localVarResponse, typeof(CreateServerResponse)));
        }
        ...
        public ApiResponse< CreateServerResponse > AttachStorageWithHttpInfo (Guid? serverId, AttachStorageDeviceRequest storageDevice)
        {
            ...
            {
                localVarPostBody = this.Configuration.ApiClient.Serialize(storageDevice); // http body (model) parameter
            }
            else
            {
        ...
        /// <summary>
        /// Cancel server operation Cancels a running server operation.
        /// </summary>
        /// <exception cref="Upcloud.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="serverId">Id of server on which to cancel the current operation.</param>
        /// <returns></returns>
        public void CancelServer (Guid? serverId)
        {
             CancelServerWithHttpInfo(serverId);
        }
        ...
        /// <param name="serverId">Id of server on which to cancel the current operation.</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public ApiResponse<Object> CancelServerWithHttpInfo (Guid? serverId)
        {
            // verify the required parameter 'serverId' is set
            if (serverId == null)
                throw new ApiException(400, "Missing required parameter 'serverId' when calling ServerApi->CancelServer");

            var localVarPath = "./server/{serverId}/cancel";
            var localVarPathParams = new Dictionary<String, String>();
            var localVarQueryParams = new List<KeyValuePair<String, String>>();
            var localVarHeaderParams = new Dictionary<String, String>(this.Configuration.DefaultHeader);
            var localVarFormParams = new Dictionary<String, String>();
            ...
            if (ExceptionFactory != null)
            {
                Exception exception = ExceptionFactory("CancelServer", localVarResponse);
                if (exception != null) throw exception;
            }
        ...
        /// <param name="serverId">Id of server on which to cancel the current operation.</param>
        /// <returns>Task of void</returns>
        public async System.Threading.Tasks.Task CancelServerAsync (Guid? serverId)
        {
             await CancelServerAsyncWithHttpInfo(serverId);
        ...
        /// <param name="serverId">Id of server on which to cancel the current operation.</param>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<ApiResponse<Object>> CancelServerAsyncWithHttpInfo (Guid? serverId)
        {
            // verify the required parameter 'serverId' is set
            if (serverId == null)
                throw new ApiException(400, "Missing required parameter 'serverId' when calling ServerApi->CancelServer");
        ...
        public ApiResponse< FirewallRuleCreateResponse > CreateFirewallRuleWithHttpInfo (Guid? serverId, FirewallRuleRequest firewallRule)
        {
            ...
            {
                localVarPostBody = this.Configuration.ApiClient.Serialize(firewallRule); // http body (model) parameter
            }
            else
            {
            ...
            return new ApiResponse<FirewallRuleCreateResponse>(localVarStatusCode,
                localVarResponse.Headers.ToDictionary(x => x.Key, x => x.Value.ToString()),
                (FirewallRuleCreateResponse) this.Configuration.ApiClient.Deserialize(localVarResponse, typeof(FirewallRuleCreateResponse)));
        }
        ...
        public ApiResponse< CreateServerResponse > CreateServerWithHttpInfo (CreateServerRequest server = null)
        {
            ...
            {
                localVarPostBody = this.Configuration.ApiClient.Serialize(server); // http body (model) parameter
            }
            else
            {
        ...
        public ApiResponse<Object> DeleteFirewallRuleWithHttpInfo (Guid? serverId, decimal? firewallRuleNumber)
        {
            ...
            if (serverId != null) localVarPathParams.Add("serverId", this.Configuration.ApiClient.ParameterToString(serverId)); // path parameter
            if (firewallRuleNumber != null) localVarPathParams.Add("firewallRuleNumber", this.Configuration.ApiClient.ParameterToString(firewallRuleNumber)); // path parameter
        ...
        /// <param name="storages">Detaches and deletes storages on the server. (optional)</param>
        /// <returns></returns>
        public void DeleteServer (Guid? serverId, decimal? storages = null)
        {
             DeleteServerWithHttpInfo(serverId, storages);
        }
        ...
        /// <param name="storages">Detaches and deletes storages on the server. (optional)</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public ApiResponse<Object> DeleteServerWithHttpInfo (Guid? serverId, decimal? storages = null)
        {
            // verify the required parameter 'serverId' is set
            if (serverId == null)
            ...
            if (serverId != null) localVarPathParams.Add("serverId", this.Configuration.ApiClient.ParameterToString(serverId)); // path parameter
            if (storages != null) localVarQueryParams.AddRange(this.Configuration.ApiClient.ParameterToKeyValuePairs("", "storages", storages)); // query parameter
        ...
        /// <param name="storages">Detaches and deletes storages on the server. (optional)</param>
        /// <returns>Task of void</returns>
        public async System.Threading.Tasks.Task DeleteServerAsync (Guid? serverId, decimal? storages = null)
        {
             await DeleteServerAsyncWithHttpInfo(serverId, storages);
        ...
        /// <param name="storages">Detaches and deletes storages on the server. (optional)</param>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<ApiResponse<Object>> DeleteServerAsyncWithHttpInfo (Guid? serverId, decimal? storages = null)
        {
            // verify the required parameter 'serverId' is set
            if (serverId == null)
                throw new ApiException(400, "Missing required parameter 'serverId' when calling ServerApi->DeleteServer");
        ...
        public ApiResponse< ConfigurationListResponse > ListServerConfigurationsWithHttpInfo ()
        {
            ...
            return new ApiResponse<ConfigurationListResponse>(localVarStatusCode,
                localVarResponse.Headers.ToDictionary(x => x.Key, x => x.Value.ToString()),
                (ConfigurationListResponse) this.Configuration.ApiClient.Deserialize(localVarResponse, typeof(ConfigurationListResponse)));
        }
        ...
        public ApiResponse< ServerListResponse > ListServersWithHttpInfo ()
        {
            ...
            return new ApiResponse<ServerListResponse>(localVarStatusCode,
                localVarResponse.Headers.ToDictionary(x => x.Key, x => x.Value.ToString()),
                (ServerListResponse) this.Configuration.ApiClient.Deserialize(localVarResponse, typeof(ServerListResponse)));
        }
        ...
        public ApiResponse< CreateServerResponse > LoadCdromWithHttpInfo (Guid? serverId, StorageDeviceLoadRequest storageDevice = null)
        {
            ...
            var localVarPath = "./server/{serverId}/cdrom/load";
            var localVarPathParams = new Dictionary<String, String>();
            var localVarQueryParams = new List<KeyValuePair<String, String>>();
            var localVarHeaderParams = new Dictionary<String, String>(this.Configuration.DefaultHeader);
            var localVarFormParams = new Dictionary<String, String>();
        ...
        public ApiResponse< CreateServerResponse > RestartServerWithHttpInfo (Guid? serverId, RestartServer restartServer)
        {
            ...
            {
                localVarPostBody = this.Configuration.ApiClient.Serialize(restartServer); // http body (model) parameter
            }
            else
            {
        ...
        public ApiResponse< FirewallRuleListResponse > ServerServerIdFirewallRuleGetWithHttpInfo (Guid? serverId)
        {
            ...
            return new ApiResponse<FirewallRuleListResponse>(localVarStatusCode,
                localVarResponse.Headers.ToDictionary(x => x.Key, x => x.Value.ToString()),
                (FirewallRuleListResponse) this.Configuration.ApiClient.Deserialize(localVarResponse, typeof(FirewallRuleListResponse)));
        }
        ...
        public ApiResponse< CreateServerResponse > StopServerWithHttpInfo (Guid? serverId, StopServer stopServerRequest)
        {
            ...
            {
                localVarPostBody = this.Configuration.ApiClient.Serialize(stopServerRequest); // http body (model) parameter
            }
            else
            {
        ...
        public ApiResponse< CreateServerResponse > UntagWithHttpInfo (Guid? serverId, string tagName)
        {
            ...
            if (serverId != null) localVarPathParams.Add("serverId", this.Configuration.ApiClient.ParameterToString(serverId)); // path parameter
            if (tagName != null) localVarPathParams.Add("tagName", this.Configuration.ApiClient.ParameterToString(tagName)); // path parameter
